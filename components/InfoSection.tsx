        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-6 w-full">
            ...
            <div className="mt-12 pt-8 border-t border-cyan-400/30">
              <h3 ref={connectTitleRef} className="text-2xl md:text-3xl font-bold text-cyan-400 mb-4">
                Let's Connect
              </h3>
              <p ref={connectParaRef} className="text-lg md:text-xl font-light leading-relaxed text-gray-300">
